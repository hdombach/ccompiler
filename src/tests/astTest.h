...
static void astFuncOperationTest() {
	...
	tAstSuccess(
			...
			(ASTNodeType[]) {
				...
				AST_FUNC_DEF, AST_TYPE_SPEC, AST_DECLARATOR, AST_FUNC_DECL, AST_IDENTIFIER_DECL, AST_COMP_STM,
					AST_FUNC_OPERATION, AST_IDENTIFIER,
				AST_UNKNOWN,
			});
	...
	tAstSuccess(
			...
			(ASTNodeType[]) {
				AST_FILE,
				AST_FUNC_DEF, AST_TYPE_SPEC, AST_DECLARATOR, AST_FUNC_DECL, AST_IDENTIFIER_DECL, AST_COMP_STM,
					AST_FUNC_OPERATION, AST_IDENTIFIER, AST_STR_CONSTANT,
				AST_UNKNOWN,
			});
	...
	tAstSuccess(
			...
			(ASTNodeType[]) {
				AST_FILE,
				AST_FUNC_DEF, AST_TYPE_SPEC, AST_DECLARATOR, AST_FUNC_DECL, AST_IDENTIFIER_DECL, AST_COMP_STM,
					AST_FUNC_OPERATION, AST_IDENTIFIER, AST_BINARY_OPERATION, AST_INT_CONSTANT, AST_INT_CONSTANT,
				AST_UNKNOWN
			});
	...
	tAstSuccess(
			...
			(ASTNodeType[]) {
				AST_FILE,
				AST_FUNC_DEF, AST_TYPE_SPEC, AST_DECLARATOR, AST_FUNC_DECL, AST_IDENTIFIER_DECL, AST_COMP_STM,
					AST_FUNC_OPERATION, AST_BINARY_OPERATION, AST_IDENTIFIER, AST_IDENTIFIER,
				AST_UNKNOWN,
			});
	...
	tAstSuccess(
			...
			(ASTNodeType[]) {
				AST_FILE,
				AST_FUNC_DEF, AST_TYPE_SPEC, AST_DECLARATOR, AST_FUNC_DECL, AST_IDENTIFIER_DECL, AST_COMP_STM,
					AST_FUNC_OPERATION, AST_BINARY_OPERATION, AST_IDENTIFIER, AST_IDENTIFIER, AST_STR_CONSTANT,
				AST_UNKNOWN,
			});
	...
	tAstSuccess(
			...
			(ASTNodeType[]) {
				AST_FILE,
				AST_FUNC_DEF, AST_TYPE_SPEC, AST_DECLARATOR, AST_FUNC_DECL, AST_IDENTIFIER_DECL, AST_COMP_STM,
					AST_FUNC_OPERATION, AST_SUBS_OPERATION, AST_IDENTIFIER, AST_INT_CONSTANT, AST_IDENTIFIER,
				AST_UNKNOWN
			});
...
static void astSubsOperationTest() {
	...
	tAstSuccess(
			...
			(ASTNodeType[]) {
				AST_FILE,
				AST_FUNC_DEF, AST_TYPE_SPEC, AST_DECLARATOR, AST_FUNC_DECL, AST_IDENTIFIER_DECL, AST_COMP_STM,
					AST_SUBS_OPERATION, AST_IDENTIFIER, AST_INT_CONSTANT,
				AST_UNKNOWN,
			});
	...
	tAstSuccess(
			...
			(ASTNodeType[]) {
				AST_FILE,
				AST_FUNC_DEF, AST_TYPE_SPEC, AST_DECLARATOR, AST_FUNC_DECL, AST_IDENTIFIER_DECL, AST_COMP_STM,
					AST_SUBS_OPERATION, AST_SUBS_OPERATION, AST_IDENTIFIER, AST_INT_CONSTANT, AST_INT_CONSTANT,
				AST_UNKNOWN,
			});
	...
	tAstSuccess(
			...
			(ASTNodeType[]) {
				AST_FILE,
				AST_FUNC_DEF, AST_TYPE_SPEC, AST_DECLARATOR, AST_FUNC_DECL, AST_IDENTIFIER_DECL, AST_COMP_STM,
					AST_SUBS_OPERATION, AST_BINARY_OPERATION, AST_SUBS_OPERATION, AST_IDENTIFIER, AST_INT_CONSTANT, AST_IDENTIFIER, AST_INT_CONSTANT,
				AST_UNKNOWN,
			});
	...
	tAstSuccess(
			...
			(ASTNodeType[]) {
				AST_FILE,
				AST_FUNC_DEF, AST_TYPE_SPEC, AST_DECLARATOR, AST_FUNC_DECL, AST_IDENTIFIER_DECL, AST_COMP_STM,
					AST_SUBS_OPERATION, AST_FUNC_OPERATION, AST_IDENTIFIER, AST_INT_CONSTANT,
				AST_UNKNOWN,
			});
	...
	tAstSuccess(
			...
			(ASTNodeType[]) {
				AST_FILE,
				AST_FUNC_DEF, AST_TYPE_SPEC, AST_DECLARATOR, AST_FUNC_DECL, AST_IDENTIFIER_DECL, AST_COMP_STM,
					AST_FUNC_OPERATION, AST_SUBS_OPERATION, AST_IDENTIFIER, AST_INT_CONSTANT,
				AST_UNKNOWN,
			});
...
static void astTestIf() {
	...
	tAstSuccess(
		...
		(ASTNodeType[]) {
			...
			AST_COMP_STM, AST_IF, AST_IDENTIFIER, AST_COMP_STM,
	...
	tAstSuccess(
		...
		(ASTNodeType[]) {
			...
			AST_IDENTIFIER_DECL, AST_COMP_STM, AST_IF, AST_IDENTIFIER, 
			AST_COMP_STM, AST_FUNC_OPERATION, AST_IDENTIFIER, AST_IF,
			AST_IDENTIFIER, AST_COMP_STM, AST_BINARY_OPERATION,
	...
	tAstSuccess(
		...
		(ASTNodeType[]) {
			AST_FILE, AST_FUNC_DEF, AST_TYPE_SPEC, AST_DECLARATOR, AST_FUNC_DECL,
			AST_IDENTIFIER_DECL, AST_COMP_STM, AST_IF, AST_IDENTIFIER,
			AST_COMP_STM, AST_FUNC_OPERATION, AST_IDENTIFIER,
			AST_COMP_STM, AST_BINARY_OPERATION, AST_IDENTIFIER,
	...
	tAstSuccess(
		...
		(ASTNodeType[]) {
			...
			AST_IDENTIFIER_DECL, AST_COMP_STM, AST_IF, AST_IDENTIFIER,
			AST_COMP_STM, AST_FUNC_OPERATION, AST_IDENTIFIER,
			AST_IF, AST_INT_CONSTANT, AST_COMP_STM, 
...
static void astSwitchTest() {
	...
	tAstSuccess(
		...
		(ASTNodeType[]) {
			AST_FILE, AST_FUNC_DEF, AST_TYPE_SPEC, AST_DECLARATOR, AST_FUNC_DECL,
			AST_IDENTIFIER_DECL, AST_COMP_STM, AST_SWITCH, AST_IDENTIFIER,
			AST_COMP_STM, AST_LBL_CASE, AST_INT_CONSTANT, AST_RETURN,
			AST_INT_CONSTANT, AST_LBL_DEFAULT, AST_RETURN, AST_INT_CONSTANT,
			AST_UNKNOWN
		});
	...
	tAstSuccess(
		...
		(ASTNodeType[]) {
			AST_FILE, AST_FUNC_DEF, AST_TYPE_SPEC, AST_DECLARATOR, AST_FUNC_DECL, 
			AST_IDENTIFIER_DECL, AST_COMP_STM, AST_SWITCH, AST_IDENTIFIER, 
			AST_COMP_STM, AST_LBL_CASE, AST_INT_CONSTANT,
...
static void astWhileTest() {
	...
	tAstSuccess(
		...
		(ASTNodeType[]) {
			AST_FILE, AST_FUNC_DEF, AST_TYPE_SPEC, AST_DECLARATOR, AST_FUNC_DECL,
			AST_IDENTIFIER_DECL, AST_COMP_STM, AST_WHILE, AST_INT_CONSTANT,
			AST_EMPTY_STM, AST_UNKNOWN,
		});
	...
	tAstSuccess(
		...
		(ASTNodeType[]) {
			AST_FILE, AST_FUNC_DEF, AST_TYPE_SPEC, AST_DECLARATOR, AST_FUNC_DECL,
			AST_IDENTIFIER_DECL, AST_COMP_STM, AST_WHILE,
			AST_PREFIX_OPERATION, AST_IDENTIFIER, AST_POSTFIX_OPERATION,
			AST_IDENTIFIER, AST_UNKNOWN,
		});
	...
	tAstSuccess(
		...
		(ASTNodeType[]) {
			AST_FILE, AST_FUNC_DEF, AST_TYPE_SPEC, AST_DECLARATOR, AST_FUNC_DECL,
			AST_IDENTIFIER_DECL, AST_COMP_STM, AST_WHILE,
			AST_PREFIX_OPERATION, AST_IDENTIFIER, AST_COMP_STM, 
			AST_POSTFIX_OPERATION, AST_IDENTIFIER, AST_UNKNOWN,
		});
...
static void astDoWhileTest() {
	...
	tAstSuccess(
		...
		(ASTNodeType[]) {
			AST_FILE, AST_FUNC_DEF, AST_TYPE_SPEC, AST_DECLARATOR, AST_FUNC_DECL,
			AST_IDENTIFIER_DECL, AST_COMP_STM, AST_DO_WHILE, 
...
static void astEmptyStmTest() {
	...
	tAstSuccess(
		...
		(ASTNodeType[]) {
			AST_FILE, AST_FUNC_DEF, AST_TYPE_SPEC, AST_DECLARATOR, AST_FUNC_DECL,
			AST_IDENTIFIER_DECL, AST_COMP_STM, AST_EMPTY_STM,
			AST_EMPTY_STM, AST_EMPTY_STM, AST_UNKNOWN,
		});
}
...
static void astGotoTest() {
	...
	tAstSuccess(
		...
		(ASTNodeType[]) {
			AST_FILE, AST_FUNC_DEF, AST_TYPE_SPEC, AST_DECLARATOR, AST_FUNC_DECL,
			AST_IDENTIFIER_DECL, AST_COMP_STM, AST_LBL_IDENTIFIER,
	...
	tAstSuccess(
		...
		(ASTNodeType[]) {
			AST_FILE, AST_FUNC_DEF, AST_TYPE_SPEC, AST_DECLARATOR, AST_FUNC_DECL,
			AST_IDENTIFIER_DECL, AST_COMP_STM, AST_LBL_IDENTIFIER,
			AST_LBL_IDENTIFIER, AST_GOTO, AST_GOTO, AST_UNKNOWN,
		});
	...
	tAstSuccess(
		...
		(ASTNodeType[]) {
			AST_FILE, AST_FUNC_DEF, AST_TYPE_SPEC, AST_DECLARATOR, AST_FUNC_DECL,
			AST_IDENTIFIER_DECL, AST_COMP_STM, AST_LBL_CASE, AST_INT_CONSTANT,
...
static void astForTest() {
	...
	tAstSuccess(
		...
		(ASTNodeType[]) {
			AST_FILE, AST_FUNC_DEF, AST_TYPE_SPEC, AST_DECLARATOR, AST_FUNC_DECL,
			AST_IDENTIFIER_DECL, AST_COMP_STM, AST_FOR, 
			AST_EMPTY_STM, AST_UNKNOWN,
		});
	...
	tAstSuccess(
		...
		(ASTNodeType[]) {
			...
			AST_DECLARATOR, AST_IDENTIFIER_DECL, AST_INT_CONSTANT, 
			...
			AST_INT_CONSTANT, AST_COMP_STM, AST_FUNC_OPERATION,
	...
	tAstSuccess(
		...
		(ASTNodeType[]) {
			AST_FILE, AST_FUNC_DEF, AST_TYPE_SPEC, AST_DECLARATOR, AST_FUNC_DECL,
			AST_IDENTIFIER_DECL, AST_COMP_STM, AST_FOR, AST_DECLARATION,
			...
			AST_IDENTIFIER, AST_INT_CONSTANT, AST_COMP_STM,
...
static void astReturnTest() {
	...
	tAstSuccess(
		...
		(ASTNodeType[]) {
			AST_FILE, AST_FUNC_DEF, AST_TYPE_SPEC, AST_DECLARATOR, AST_FUNC_DECL,
			AST_IDENTIFIER_DECL, AST_COMP_STM, AST_RETURN, AST_UNKNOWN,
		});
	...
	tAstSuccess(
		...
		(ASTNodeType[]) {
			AST_FILE, AST_FUNC_DEF, AST_TYPE_SPEC, AST_DECLARATOR, AST_FUNC_DECL,
			AST_IDENTIFIER_DECL, AST_COMP_STM, AST_RETURN, AST_INT_CONSTANT,
			AST_UNKNOWN,
		});
	...
	tAstSuccess(
		...
		(ASTNodeType[]) {
			AST_FILE, AST_FUNC_DEF, AST_TYPE_SPEC, AST_DECLARATOR, AST_FUNC_DECL, 
			AST_IDENTIFIER_DECL, AST_COMP_STM, AST_RETURN,
